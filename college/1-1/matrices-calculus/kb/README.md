...
- `data/topics.json` — stable topic IDs and source-backed Unit I notes
- `data/textbook-questions.json` — R25-filtered Grewal Unit I practice bank
...
Raw commercial textbook scans remain intake/provenance material and are **not** copied into the public workspace.
